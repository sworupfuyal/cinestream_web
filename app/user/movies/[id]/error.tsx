    ...
    return (
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6">
            <div className="bg-slate-900 rounded-xl p-8 max-w-md w-full text-center">
                ...
                <h2 className="text-xl font-bold text-white mb-2">Failed to load movie</h2>
                <p className="text-gray-400 text-sm mb-6">
                    {error.message || "An unexpected error occurred while loading this movie."}
                </p>
                <div className="flex items-center justify-center gap-3">
                    ...
                    <a
                        href="/user/dashboard"
                        className="text-gray-400 hover:text-white px-5 py-2.5 rounded-lg font-semibold text-sm transition"
                    >
                        Back to Dashboard
                    </a>
                </div>
